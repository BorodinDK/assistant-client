...
export const NativePanel: React.FC<Omit<NativePanelProps, 'hideNativePanel'>> = ({
    ...
    const createSuggestClickHandler = (suggest: Suggestions['buttons'][0]) => () => {
    ...
    return (
        <div className={`nativePanel ${className ?? ''} ${isVisibleInputTouch ? ' keyboard-visible' : ''}`}>
            ...
            <div className="suggestPanel">
                {suggestions.map((s: Suggestions['buttons'][0]) => (
